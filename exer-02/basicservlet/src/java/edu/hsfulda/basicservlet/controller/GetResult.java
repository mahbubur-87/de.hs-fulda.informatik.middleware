...
public class GetResult extends HttpServlet {
    ...
    private final String TAX_FORM_HTML = this.getClass().getResource("tax-form_1.html").getPath();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            sb.insert(sb.indexOf("<hr>") + 5, "<p>" + TaxService.getInstance()
                                                                .getResultsFromLogFile()
                                                                .replaceAll("\\|", "<br>")+ "</p>");
